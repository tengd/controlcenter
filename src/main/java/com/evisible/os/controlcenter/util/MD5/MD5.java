package com.evisible.os.controlcenter.util.MD5;
	 ...
	 public static void main(String args[])
	    {
	        String str = "admin";
	        MD5 md5 = new MD5(str);
	        System.out.println("一次加密（32位）：" + md5.mac32());
	        System.out.println("一次加密（16位）：" + md5.mac16());

	     /*   System.out.println("二次加密（32位）：" + md5.mac32d());

	        System.out.println("二次加密（16位）：" + md5.mac16d());*/
	    }
	    ...
	    public String mac16()
	    {
	    	return asHex().substring(8,24);
	    }
	    
	    public String mac32d()
	    {
	    	return new MD5(mac32()).mac32();       
	    }
	    
	    public String mac16d()
	    {
	    	return new MD5(mac16()).mac16();       
	    }
	    ...
	    private int[] Decode(byte buffer[], int len, int shift)
	    {
	        ...
	        for (; j < len; j += 4)
	        {
	            out[i] = buffer[j + shift] & 0xff | (buffer[j + 1 + shift] & 0xff) << 8 |
